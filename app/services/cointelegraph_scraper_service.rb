...
class CointelegraphScraperService

  attr_accessor :@urls_to_scrape, :@cointelegraph_articles
  ...
  def perform
    #go to CT latest news URL and open the file
    ...
    @urls_to_scrape.each do |url|
      ...
      article = {
       ...
       @cointelegraph_articles << article
    end
  end
